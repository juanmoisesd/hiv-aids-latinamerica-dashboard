...
### APA 7ª Edición
```
de la Serna Tuya, J. M. (2026). HIV/AIDS in Latin America 2000-2020: Epidemiological Data Dashboard. GitHub. https://github.com/juanmoisesd/hiv-aids-latinamerica-dashboard
```

### Chicago Autor-Fecha
```
de la Serna Tuya, Juan Moisés. 2026. "HIV/AIDS in Latin America 2000-2020: Epidemiological Data Dashboard." GitHub. https://github.com/juanmoisesd/hiv-aids-latinamerica-dashboard.
```

### BibTeX
```bibtex
@misc{delaserna2026_hivaidslatin,
  author       = {de la Serna Tuya, Juan Moisés},
  title        = {HIV/AIDS in Latin America 2000-2020: Epidemiological Data Dashboard},
  year         = {2026},
...
TI  - HIV/AIDS in Latin America 2000-2020: Epidemiological Data Dashboard
PY  - 2026
PB  - GitHub
UR  - https://github.com/juanmoisesd/hiv-aids-latinamerica-dashboard
...
### Vancouver / IEEE
```
de la Serna Tuya JM. HIV/AIDS in Latin America 2000-2020: Epidemiological Data Dashboard. GitHub; 2026. Available: https://github.com/juanmoisesd/hiv-aids-latinamerica-dashboard. ORCID: 0000-0002-8401-8018.
```
